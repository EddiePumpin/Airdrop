...
contract MakeMerkle is Script, ScriptHelper {
    ...
    Merkle private m = new Merkle(); // instance of the merkle contract from Murky to do shit. Basically, generating proofs and verifying them
    ...
    /// @dev Generate the JSON entries for the output file. Basically, it is just formating the output in JSON format
    ...
    function run() public {
        ...
        for (uint256 i = 0; i < count; ++i) {
            ...
            bytes32[] memory data = new bytes32[](types.length); // actual data as a bytes32. The hashed form of the input data(address and amount)
