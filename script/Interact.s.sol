...
contract ClaimAirdrop is Script {
    ...
    bytes private SIGNATURE =
        hex"fbd2270e6f23fb5fe9248480c0f4be8a4e9bd77c3ad0b1333cc60b5debc511602a2a06c24085d8d7c038bad84edc53664c8ce0346caeaa3570afec0e61144dc11c"; // r, s and V are encodePacked in this order
    ...
    function splitSignature(bytes memory sig) public pure returns (uint8 v, bytes32 r, bytes32 s) {
        ...
        assembly {
            // We are using assembly to break the signature up here
            r := mload(add(sig, 32))
            s := mload(add(sig, 64))
